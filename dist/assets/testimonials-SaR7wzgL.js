import"./modulepreload-polyfill-B5Qt9EMX.js";import{initializeApp as D}from"https://www.gstatic.com/firebasejs/9.6.1/firebase-app.js";import{getFirestore as F,query as N,collection as z,where as O,getDocs as M}from"https://www.gstatic.com/firebasejs/9.6.1/firebase-firestore.js";const P={apiKey:"AIzaSyA3x-CZApUgkWHCjlwvFtOQhYQeY6lDwpI",authDomain:"twenty-forth-fifth.firebaseapp.com",projectId:"twenty-forth-fifth",storageBucket:"twenty-forth-fifth.firebasestorage.app",messagingSenderId:"228269383587",appId:"1:228269383587:web:0d6f063f221f388cd2c416",measurementId:"G-3X9DT5MBV4"};try{let c=function(i){const t=localStorage.getItem(`likes_${i}`);return t?JSON.parse(t):{likes:0,dislikes:0,userLiked:!1,userDisliked:!1}},v=function(i,t){localStorage.setItem(`likes_${i}`,JSON.stringify(t))},k=function(i){const t=c(i);t.userLiked?(t.likes=Math.max(0,t.likes-1),t.userLiked=!1):(t.userDisliked&&(t.dislikes=Math.max(0,t.dislikes-1),t.userDisliked=!1),t.likes+=1,t.userLiked=!0),v(i,t),h(m)},S=function(i){const t=c(i);t.userDisliked?(t.dislikes=Math.max(0,t.dislikes-1),t.userDisliked=!1):(t.userLiked&&(t.likes=Math.max(0,t.likes-1),t.userLiked=!1),t.dislikes+=1,t.userDisliked=!0),v(i,t),h(m)},I=function(i,t){const a=[...i];switch(t){case"oldest":return a.sort((e,s)=>{const r=e.createdAt instanceof Date?e.createdAt:new Date(e.createdAt),o=s.createdAt instanceof Date?s.createdAt:new Date(s.createdAt);return r-o});case"rating":return a.sort((e,s)=>(s.rating||0)-(e.rating||0));case"likes":return a.sort((e,s)=>{const r=c(e.id).likes;return c(s.id).likes-r});case"newest":default:return a.sort((e,s)=>{const r=e.createdAt instanceof Date?e.createdAt:new Date(e.createdAt);return(s.createdAt instanceof Date?s.createdAt:new Date(s.createdAt))-r})}},T=function(i,t){if(t==="all")return i;if(t==="verified")return i.filter(a=>a.verified);if(t==="5star")return i.filter(a=>a.rating===5);if(t==="business")return i.filter(a=>(a.company||"").trim().length>0);if(t==="individual")return i.filter(a=>(a.company||"").trim().length===0);if(t==="recent"){const a=new Date;return a.setDate(a.getDate()-30),i.filter(e=>(e.createdAt instanceof Date?e.createdAt:new Date(e.createdAt))>=a)}return i},A=function(i,t){if(!t)return i;const a=t.toLowerCase();return i.filter(e=>e.authorName&&e.authorName.toLowerCase().includes(a)||e.company&&e.company.toLowerCase().includes(a)||e.country&&e.country.toLowerCase().includes(a)||e.reviewText&&e.reviewText.toLowerCase().includes(a))},L=function(i){const t=i.length,a=i.length>0?(i.reduce((r,o)=>r+(o.rating||0),0)/i.length).toFixed(1):"0.0",e=i.filter(r=>r.verified).length,s=new Set(i.map(r=>r.country).filter(r=>r)).size;document.getElementById("totalReviews").textContent=t,document.getElementById("avgRating").textContent=a,document.getElementById("verifiedCount").textContent=e,document.getElementById("countriesCount").textContent=s},h=function(i){const t=document.getElementById("testimonials-container");if(i.length===0){t.innerHTML=`
              <div class="bg-white rounded-xl border border-gray-200 p-12 text-center">
                <i class="fas fa-comments text-gray-300 text-5xl mb-4"></i>
                <h3 class="text-xl font-semibold text-gray-900 mb-2">No Testimonials Found</h3>
                <p class="text-gray-600">Try adjusting your search or filter criteria.</p>
              </div>
            `;return}const a=I(i,x);t.innerHTML=a.map((e,s)=>{const r="⭐".repeat(e.rating||0),o="☆".repeat(5-(e.rating||0)),l=e.createdAt.toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"}),n=Math.ceil((e.reviewText||"").split(" ").length/200),d=c(e.id),w=e.likeCount===0||e.likeCount?Number(e.likeCount):null,E=Number.isFinite(w)?`<span class="text-sm text-gray-600 flex items-center gap-1">
