import"./modulepreload-polyfill-B5Qt9EMX.js";import{initializeApp as C}from"https://www.gstatic.com/firebasejs/9.6.1/firebase-app.js";import{getFirestore as F,query as N,collection as z,where as O,getDocs as P}from"https://www.gstatic.com/firebasejs/9.6.1/firebase-firestore.js";const M={apiKey:"AIzaSyDk8K22XfrsAQAX7WarxSq_BnwO1YQLDSc",authDomain:"twenty-third-forth-ee57c.firebaseapp.com",projectId:"twenty-third-forth-ee57c",storageBucket:"twenty-third-forth-ee57c.firebasestorage.app",messagingSenderId:"47210898997",appId:"1:47210898997:web:d25c23eee45a7660cef37c",measurementId:"G-ESYD665GWG"};try{let c=function(i){const t=localStorage.getItem(`likes_${i}`);return t?JSON.parse(t):{likes:0,dislikes:0,userLiked:!1,userDisliked:!1}},v=function(i,t){localStorage.setItem(`likes_${i}`,JSON.stringify(t))},k=function(i){const t=c(i);t.userLiked?(t.likes=Math.max(0,t.likes-1),t.userLiked=!1):(t.userDisliked&&(t.dislikes=Math.max(0,t.dislikes-1),t.userDisliked=!1),t.likes+=1,t.userLiked=!0),v(i,t),h(m)},S=function(i){const t=c(i);t.userDisliked?(t.dislikes=Math.max(0,t.dislikes-1),t.userDisliked=!1):(t.userLiked&&(t.likes=Math.max(0,t.likes-1),t.userLiked=!1),t.dislikes+=1,t.userDisliked=!0),v(i,t),h(m)},A=function(i,t){const a=[...i];switch(t){case"oldest":return a.sort((e,s)=>{const r=e.createdAt instanceof Date?e.createdAt:new Date(e.createdAt),o=s.createdAt instanceof Date?s.createdAt:new Date(s.createdAt);return r-o});case"rating":return a.sort((e,s)=>(s.rating||0)-(e.rating||0));case"likes":return a.sort((e,s)=>{const r=c(e.id).likes;return c(s.id).likes-r});case"newest":default:return a.sort((e,s)=>{const r=e.createdAt instanceof Date?e.createdAt:new Date(e.createdAt);return(s.createdAt instanceof Date?s.createdAt:new Date(s.createdAt))-r})}},I=function(i,t){if(t==="all")return i;if(t==="verified")return i.filter(a=>a.verified);if(t==="5star")return i.filter(a=>a.rating===5);if(t==="business")return i.filter(a=>(a.company||"").trim().length>0);if(t==="individual")return i.filter(a=>(a.company||"").trim().length===0);if(t==="recent"){const a=new Date;return a.setDate(a.getDate()-30),i.filter(e=>(e.createdAt instanceof Date?e.createdAt:new Date(e.createdAt))>=a)}return i},T=function(i,t){if(!t)return i;const a=t.toLowerCase();return i.filter(e=>e.authorName&&e.authorName.toLowerCase().includes(a)||e.company&&e.company.toLowerCase().includes(a)||e.country&&e.country.toLowerCase().includes(a)||e.reviewText&&e.reviewText.toLowerCase().includes(a))},L=function(i){const t=i.length,a=i.length>0?(i.reduce((r,o)=>r+(o.rating||0),0)/i.length).toFixed(1):"0.0",e=i.filter(r=>r.verified).length,s=new Set(i.map(r=>r.country).filter(r=>r)).size;document.getElementById("totalReviews").textContent=t,document.getElementById("avgRating").textContent=a,document.getElementById("verifiedCount").textContent=e,document.getElementById("countriesCount").textContent=s},h=function(i){const t=document.getElementById("testimonials-container");if(i.length===0){t.innerHTML=`
              <div class="bg-white rounded-xl border border-gray-200 p-12 text-center">
                <i class="fas fa-comments text-gray-300 text-5xl mb-4"></i>
                <h3 class="text-xl font-semibold text-gray-900 mb-2">No Testimonials Found</h3>
                <p class="text-gray-600">Try adjusting your search or filter criteria.</p>
              </div>
            `;return}const a=A(i,x);t.innerHTML=a.map((e,s)=>{const r="⭐".repeat(e.rating||0),o="☆".repeat(5-(e.rating||0)),l=e.createdAt.toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"}),n=Math.ceil((e.reviewText||"").split(" ").length/200),d=c(e.id),w=e.likeCount===0||e.likeCount?Number(e.likeCount):null,E=Number.isFinite(w)?`<span class="text-sm text-gray-600 flex items-center gap-1">
                   <i class="fas fa-heart text-red-500"></i>
                   <span class="font-medium">${w}</span>
                 </span>`:"",y=(e.company||"").trim().length>0?"Business":"Individual",D=y==="Business"?"bg-blue-50 text-blue-700 border-blue-200":"bg-gray-50 text-gray-700 border-gray-200";return`
              <article 
              ...
              >
                ...
                <div class="mb-5 relative z-10">
                  <div class="flex items-center gap-3 mb-4 flex-wrap">
                    ...
                    <span class="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold border-2 ${D} shadow-sm">
            ...
            `}).join("")},B=function(i){const t=i.length>0?(i.reduce((n,d)=>n+(d.rating||0),0)/i.length).toFixed(1):"0.0",a={"@context":"https://schema.org","@type":"Organization","@id":"https://twentyforthfifth.com/#organization",name:"Twenty Forth & Fifth",alternateName:"Twenty Forth & Fifth",url:"https://twentyforthfifth.com",logo:{"@type":"ImageObject",url:"https://twentyforthfifth.com/1.png"},description:"Twenty Forth & Fifth provides professional banking services with expertise in compliance and international transactions. Trusted by businesses worldwide.",aggregateRating:{"@type":"AggregateRating",ratingValue:t,reviewCount:i.length.toString(),bestRating:"5",worstRating:"1"},review:i.slice(0,20).map(n=>({"@type":"Review",author:{"@type":"Person",name:n.authorName||"Anonymous",...n.company?{affiliation:{"@type":"Organization",name:n.company}}:{}},reviewRating:{"@type":"Rating",ratingValue:n.rating.toString(),bestRating:"5",worstRating:"1"},reviewBody:n.reviewText,datePublished:n.createdAt.toISOString().split("T")[0],...n.verified?{reviewAspect:"Verified Customer Review"}:{}})),serviceType:"Banking Services",areaServed:{"@type":"Place",name:"Worldwide"}},e=document.getElementById("testimonials-schema");e&&(e.textContent=JSON.stringify(a));const s={"@context":"https://schema.org","@type":"Blog","@id":"https://twentyforthfifth.com/testimonials#blog",name:"Twenty Forth & Fifth Testimonials",description:"Verified client testimonials and reviews for Twenty Forth & Fifth. Read authentic customer experiences from businesses worldwide who trust Twenty Forth & Fifth for banking services.",url:"https://twentyforthfifth.com/testimonials",inLanguage:"en-US",blogPost:i.map(n=>({"@type":"BlogPosting",headline:`Review by ${n.authorName}${n.company?` from ${n.company}`:""} - Twenty Forth & Fifth`,author:{"@type":"Person",name:n.authorName||"Anonymous",...n.company?{affiliation:{"@type":"Organization",name:n.company}}:{}},datePublished:n.createdAt.toISOString(),dateModified:n.createdAt.toISOString(),reviewBody:n.reviewText,reviewRating:{"@type":"Rating",ratingValue:n.rating,bestRating:5,worstRating:1},about:{"@type":"Thing",name:"Twenty Forth & Fifth",description:"Banking Services"}})),publisher:{"@id":"https://twentyforthfifth.com/#organization"}},r=document.getElementById("blog-schema");r&&(r.textContent=JSON.stringify(s));const o={"@context":"https://schema.org","@type":"ItemList",name:"Twenty Forth & Fifth Client Testimonials",description:"List of verified client testimonials and reviews for Twenty Forth & Fifth",itemListElement:i.slice(0,10).map((n,d)=>({"@type":"ListItem",position:d+1,item:{"@type":"Review",author:{"@type":"Person",name:n.authorName||"Anonymous"},reviewRating:{"@type":"Rating",ratingValue:n.rating,bestRating:5,worstRating:1},reviewBody:n.reviewText.substring(0,200)+"...",datePublished:n.createdAt.toISOString().split("T")[0]}}))};let l=document.getElementById("itemlist-schema");l||(l=document.createElement("script"),l.type="application/ld+json",l.id="itemlist-schema",document.head.appendChild(l)),l.textContent=JSON.stringify(o)},p=function(){let i=I(m,b);i=T(i,u);const t=document.getElementById("searchResults"),a=document.getElementById("searchCount"),e=document.getElementById("clearSearch");u?(t&&t.classList.remove("hidden"),a&&(a.textContent=i.length),e&&e.classList.remove("hidden")):(t&&t.classList.add("hidden"),e&&e.classList.add("hidden")),h(i)};const g=C(M),f=F(g);let m=[],x="newest",b="all",u="";async function $(){try{console.log("🔍 Loading testimonials...");const i=N(z(f,"testimonials"),O("published","==",!0)),t=await P(i);console.log("📊 Found testimonials:",t.size),m=[],t.forEach(a=>{var s;const e=a.data();m.push({id:a.id,authorName:e.authorName||"",company:e.company||"",likeCount:e.likeCount!==void 0?e.likeCount:null,country:e.country||"",rating:e.rating||0,reviewText:e.reviewText||"",verified:e.verified||!1,authorImage:e.authorImage||"",createdAt:(s=e.createdAt)!=null&&s.toDate?e.createdAt.toDate():e.createdAt?new Date(e.createdAt):new Date})}),L(m),p(),console.log("✅ Testimonials loaded successfully")}catch(i){console.error("❌ Error loading testimonials:",i);const t=document.getElementById("testimonials-container");t.innerHTML=`
