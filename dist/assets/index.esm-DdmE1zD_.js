 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _e{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(r=>{if(ye(r)){const a=r.getImmediate();return`${a.library}/${a.version}`}else return null}).filter(r=>r).join(" ")}}function ye(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const C="@firebase/app",H="0.13.2";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const d=new ie("@firebase/app"),Se="@firebase/app-compat",Be="@firebase/analytics-compat",De="@firebase/analytics",we="@firebase/app-check-compat",ve="@firebase/app-check",Ce="@firebase/auth",Ae="@firebase/auth-compat",Ie="@firebase/database",Te="@firebase/data-connect",Me="@firebase/database-compat",$e="@firebase/functions",Oe="@firebase/functions-compat",Re="@firebase/installations",He="@firebase/installations-compat",Ne="@firebase/messaging",Le="@firebase/messaging-compat",xe="@firebase/performance",Pe="@firebase/performance-compat",Ve="@firebase/remote-config",Fe="@firebase/remote-config-compat",We="@firebase/storage",je="@firebase/storage-compat",Ue="@firebase/firestore",ke="@firebase/ai",Ge="@firebase/firestore-compat",Ke="firebase",Je={[C]:"fire-core",[Se]:"fire-core-compat",[De]:"fire-analytics",[Be]:"fire-analytics-compat",[ve]:"fire-app-check",[we]:"fire-app-check-compat",[Ce]:"fire-auth",[Ae]:"fire-auth-compat",[Ie]:"fire-rtdb",[Te]:"fire-data-connect",[Me]:"fire-rtdb-compat",[$e]:"fire-fn",[Oe]:"fire-fn-compat",[Re]:"fire-iid",[He]:"fire-iid-compat",[Ne]:"fire-fcm",[Le]:"fire-fcm-compat",[xe]:"fire-perf",[Pe]:"fire-perf-compat",[Ve]:"fire-rc",[Fe]:"fire-rc-compat",[We]:"fire-gcs",[je]:"fire-gcs-compat",[Ue]:"fire-fst",[Ge]:"fire-fst-compat",[ke]:"fire-vertex","fire-js":"fire-js",[Ke]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ot(t){A(new D("platform-logger",e=>new _e(e),"PRIVATE")),A(new D("heartbeat",e=>new rt(e),"PRIVATE")),E(C,H,t),E(C,H,"esm2017"),E("fire-js","")}ot("");var it="firebase",ct="11.10.0";/**
 * @license
